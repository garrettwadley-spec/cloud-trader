...
def _multi_run_job(run_id: str, req: MultiRunRequest) -> None:
    ...
    # v0 stub: replace with real loops calling backtest.run per symbol/strategy
    time.sleep(1)
    ...
    result = {
        ...
        "start": req.start,
        "end": req.end,
        "note": "v0 stub complete. Next: call TOOLS['backtest.run'] per symbol/strategy and aggregate.",
        "completed_at": datetime.utcnow().isoformat(),
    }

    artifact = _write_run_artifact(run_id, result)
